...
while True:
        ...
        ##                        bot = telepot.Bot('6035005237:AAG9BClCNRNEj5Nte_w4JeD2d3b5cMSLtYg')
        ##                        bot.sendMessage('1086053938', str("PERSON FALL "))

                else:
                        cv2.putText(window, "Action is either wrong or not trained" , (100,180),cv2.FONT_ITALIC, 1.8, (0,0,255),3)
